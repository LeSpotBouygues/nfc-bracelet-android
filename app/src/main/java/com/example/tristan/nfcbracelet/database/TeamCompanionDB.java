 ...
 */
public class TeamCompanionDB {
    private static final String TAG = "TeamTaskDB";

    private static final int DB_VERSION = 1;
    private static final String DB_NAME = "COP78.db";

    private static final String TABLE_TEAMS = "teams_companions_table";
    ...
    public TeamCompanionDB(Context context){
    ...
    public void insertTeam(Team team){
        ...
        int size = team.getNumberOfCompanions();
    ...
    public void displayTable() {
        ...
        for (int i=0; i < c.getCount(); i++) {
            Log.d(TAG, "id="+c.getString(NUM_COL_ID) +", team_id="+c.getString(NUM_COL_TEAM_ID) +", chief_id="+c.getString(NUM_COL_CHIEF_ID) +", companion_id=" + c.getString(NUM_COL_COMPANION_ID));
            c.moveToNext();
        }
    }
